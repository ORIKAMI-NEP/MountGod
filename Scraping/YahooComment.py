...
comment = ""
YahooUrl = ""
genre = ["domestic", "world", "business", "entertainment", "sports", "it-science", "life", "local"]

# メインループ
with open("yahooComment.txt", "w", encoding="utf-8", newline="")as f:
    for i in range(0, 7):
        ...
        for rank in range(0, 39):
            ...
            maxPage = 2
            while page < maxPage:
                driver.get(articleUrl + "/comments?order=recommended&page=" + str(page))
                time.sleep(2)
