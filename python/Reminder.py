    ...
    if "!sr" in message:
        ...
        if "!sr" == messageArray[0]:
            ...
            if len(messageArray) == 7:
                with open(
                    "json/ReminderData.json", "r", encoding="utf-8"
                ) as ReminderData:
                    ReminderData = json.load(ReminderData)
                    date = (
                        messageArray[1]
                        + "/"
                        + messageArray[2].zfill(2)
                        + "/"
                        + messageArray[3].zfill(2)
                        + " "
                        + messageArray[4].zfill(2)
                        + ":"
                        + messageArray[5].zfill(2)
                    )
